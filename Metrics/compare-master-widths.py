...
masterNames = []
for i, master in enumerate(currentFont.masters):
...
# labels for table
col1Name = currentFont.familyName # current font name
...
for g in unevenGlyphs:
    ...
    firstMaster = currentFont.masters[0]
